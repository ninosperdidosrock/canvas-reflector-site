      ...
      <section className="relative min-h-[100vh] flex items-center justify-center">
        <div className="container-page text-center pt-28 pb-24">
          <img
            src={logoFull}
            alt="Niños Perdidos"
            className="mx-auto w-full max-w-xl mb-10 drop-shadow-[0_8px_24px_rgba(0,0,0,0.7)]"
          />
          <h1 className="font-display italic text-4xl md:text-6xl lg:text-7xl leading-[0.95] text-foreground text-glow-orange">
            BIENVENIDO A<br />
